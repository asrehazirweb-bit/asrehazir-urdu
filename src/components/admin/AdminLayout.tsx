...
const AdminLayout: React.FC = () => {
    ...
    return (
        <div className="flex h-screen bg-[#f8f9fa] dark:bg-zinc-950 transition-colors duration-500 font-serif">
            {/* Sidebar */}
            <aside className="w-72 bg-white dark:bg-zinc-900 border-r border-gray-100 dark:border-zinc-800 flex flex-col shadow-xl z-20">
                <div className="p-8 border-b border-gray-50 dark:border-zinc-800 flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter leading-none">عصرِ حاضر</h2>
                ...
                <div className="flex-1 overflow-y-auto px-4 py-8 space-y-8 text-right">
                    ...
                    <div>
                        ...
                        <nav className="space-y-1.5">
                            <Link to="/" className="flex flex-row-reverse items-center space-x-reverse space-x-3 px-4 py-3.5 rounded-2xl text-gray-500 hover:bg-gray-50 dark:hover:bg-zinc-800 hover:text-gray-900 dark:hover:text-white transition-all group">
                            ...
                            <Link to="/admin/settings" className={`flex flex-row-reverse items-center space-x-reverse space-x-3 px-4 py-3.5 rounded-2xl transition-all group ${isActive('/admin/settings') ? 'bg-red-600 text-white shadow-lg' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-zinc-800 hover:text-gray-900 dark:hover:text-white'}`}>
