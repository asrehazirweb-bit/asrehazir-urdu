            ...
            <div className="relative overflow-hidden bg-white dark:bg-zinc-900 p-8 md:p-12 rounded-[2rem] border border-gray-100 dark:border-zinc-800 shadow-sm">
                <div className="relative z-10 max-w-2xl mr-0 ml-auto">
                    ...
                    <div className="mt-10 flex flex-row-reverse flex-wrap gap-4">
                        <button className="bg-red-600 hover:bg-black text-white px-10 py-4 rounded-xl font-bold text-sm transition-all flex flex-row-reverse items-center gap-3 shadow-lg shadow-red-600/20 group">
                            نئی خبر شائع کریں <Zap size={16} className="group-hover:animate-bounce" />
                        </button>
                ...
                <div className="absolute bottom-0 right-1/2 w-64 h-64 bg-zinc-600/5 rounded-full blur-[80px]"></div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 bg-white dark:bg-zinc-900 p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-zinc-800">
                    <div className="flex flex-row-reverse items-center justify-between mb-8">
                        ...
                        <button className="text-sm font-bold text-red-600 hover:text-black dark:hover:text-white transition-colors flex flex-row-reverse items-center gap-2">
                            مکمل تفصیلات <ChevronRight size={16} className="rotate-180" />
                        </button>
                    </div>
                    ...
                    <div className="space-y-4">
                        {loading ? (
                            ...
                            news.map((item) => (
                                <div key={item.id} className="group flex flex-row-reverse items-center justify-between p-5 border border-transparent hover:border-gray-50 dark:hover:border-zinc-800 hover:bg-gray-50/50 dark:hover:bg-zinc-800/30 rounded-2xl transition-all duration-300">
                                    <div className="flex flex-row-reverse items-center gap-5">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <div className="flex flex-row-reverse items-center gap-4 mt-1.5">
                                                ...
                                                <span className="text-[12px] text-gray-400 flex flex-row-reverse items-center gap-1 font-bold">
                                                    <Clock size={12} className="ml-1" /> {formatTime(item.createdAt)}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="lg:col-span-4 flex flex-col gap-8">
                    <div className="bg-zinc-900 dark:bg-black p-8 rounded-[2rem] text-white shadow-xl relative overflow-hidden group text-right">
                        <div className="absolute top-0 left-0 w-32 h-32 bg-red-600/20 rounded-full -ml-16 -mt-16 blur-2xl group-hover:bg-red-600/40 transition-colors"></div>
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-8 rounded-[2rem] border border-gray-100 dark:border-zinc-800 shadow-sm flex-1 text-right">
                        <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-widest mb-6">سسٹم کی صورتحال</h3>
                        <div className="space-y-6">
                            <div className="flex flex-row-reverse items-center gap-4">
