...
export function ContactPage() {
    return (
        <div className="min-h-screen bg-white font-serif selection:bg-primary selection:text-white pb-20 text-right" dir="rtl">
            {/* Hero Section */}
            <div className="relative pt-32 pb-20 px-4 overflow-hidden bg-zinc-900 border-b border-white/5">
                <div className="absolute top-0 right-0 w-full h-full opacity-10">
                    <div className="absolute top-0 left-0 w-96 h-96 bg-primary rounded-full blur-[120px] -ml-32 -mt-32"></div>
                </div>
                <div className="max-w-6xl mx-auto relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 border border-gray-200 text-primary text-sm font-black mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-white mb-6 tracking-tighter leading-none animate-in fade-in slide-in-from-bottom-6 duration-1000">
                        عالمی <span className="text-primary italic">نیوز ڈیسک</span>
                    </h1>
            ...
            <div className="max-w-6xl mx-auto px-4 -mt-10 relative z-20">
                <div className="grid lg:grid-cols-3 gap-8 text-right">
                    ...
                    <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl shadow-black/5 border border-gray-100 flex flex-col items-center text-center group hover:border-primary transition-all duration-500">
                        ...
                        <h3 className="text-2xl font-black text-zinc-900 mb-2">ای میل ڈیسک</h3>
                    ...
                    <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl shadow-black/5 border border-gray-100 flex flex-col items-center text-center group hover:border-primary transition-all duration-500">
                        ...
                        <h3 className="text-2xl font-black text-zinc-900 mb-2">ہاٹ لائن</h3>
                        <p className="text-zinc-500 text-sm mb-6 font-medium">بریکنگ نیوز یا خبروں کی اطلاع کے لیے</p>
                        <span className="text-lg font-bold text-zinc-900" dir="ltr">+91 40 1234 5678</span>
                    </div>
                    ...
                    <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl shadow-black/5 border border-gray-100 flex flex-col items-center text-center group hover:border-primary transition-all duration-500">
                        ...
                        <h3 className="text-2xl font-black text-zinc-900 mb-2">مقام</h3>
                        <p className="text-zinc-500 text-sm mb-6 font-medium">بنجارہ ہلز، روڈ نمبر 12</p>
                        <span className="text-lg font-bold text-zinc-900">حیدرآباد، انڈیا</span>
                    </div>
                </div>
                ...
                <div className="mt-20 grid md:grid-cols-2 gap-12 items-center text-right">
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-4xl font-black text-zinc-900 tracking-tighter mb-4 leading-tight">
                                عالمی مارکیٹ میں <br /><span className="text-primary italic">ہماری موجودگی</span>
                            </h2>
                        ...
                        <div className="space-y-4">
                            {[
                                { icon: <Clock className="text-primary" />, title: "24/7 آپریشنز", desc: "ہمارا نیوز روم کبھی نہیں سوتا۔" },
                                { icon: <Globe className="text-primary" />, title: "عالمی رسائی", desc: "50 سے زائد ممالک میں پڑھا جاتا ہے۔" },
                                { icon: <Shield className="text-primary" />, title: "تصدیق شدہ رپورٹس", desc: "ماہر ایڈیٹرز کے ذریعے حقائق کی جانچ پڑتال۔" }
                            ].map((item, idx) => (
                                <div key={idx} className="flex gap-4 p-4 rounded-2xl hover:bg-zinc-50 transition-colors items-start">
                                    <div className="mt-1">{item.icon}</div>
                                    <div>
                                        <h4 className="font-bold text-zinc-900 text-md tracking-wide">{item.title}</h4>
                    ...
                    <div className="bg-zinc-900 p-8 rounded-[3rem] shadow-3xl text-white relative overflow-hidden group">
                        <div className="absolute top-0 left-0 w-64 h-64 bg-primary/20 rounded-full blur-[80px] -ml-32 -mt-32 transition-colors group-hover:bg-primary/30"></div>
...
export function AboutPage() {
    return (
        <div className="min-h-screen bg-white font-serif pb-20 text-right" dir="rtl">
            {/* Hero Section */}
            <div className="pt-32 pb-24 text-center px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    <h2 className="text-primary text-sm font-black uppercase tracking-[0.4em] mb-4">ہمارا ورثہ</h2>
                    <h1 className="text-6xl md:text-8xl font-black text-zinc-900 tracking-tighter leading-[1.1] mb-8">
                        صحافت کی <br /><span className="text-primary italic underline decoration-zinc-900/10 decoration-8 underline-offset-[12px]">آواز</span>
                    </h1>
                    <p className="text-zinc-500 text-lg md:text-3xl max-w-2xl mx-auto italic py-6 border-y border-zinc-100">
            ...
            <div className="max-w-5xl mx-auto px-4 grid lg:grid-cols-2 gap-20 items-center mt-10 text-right">
                <div className="space-y-8">
                    <div className="space-y-4">
                        ...
                        <h3 className="text-4xl font-black text-zinc-900 uppercase leading-tight">
                            ہمارا سفر <span className="text-primary">&</span> وژن
                        </h3>
                    </div>
                    <div className="text-zinc-500 text-xl leading-relaxed space-y-6 font-medium">
                        <p>
                            دیانتداری، شفافیت اور بے خوفی کے ستونوں پر مبنی، <span className="text-zinc-900 font-black underline decoration-primary decoration-2">عصر حاضر</span> ایک مقامی نیوز ڈیسک سے ایک عالمی ڈیجیٹل پاور ہاؤس بن کر ابھرا ہے۔
                        </p>
                        <p>
                            غلط معلومات کے اس دور میں، ہم تصدیق شدہ سچائی کے مینار کے طور پر کام کرتے ہیں۔ ہمارا مشن ایسی صحافت فراہم کرنا ہے جو صرف واقعات کی اطلاع نہ دے، بلکہ ان کی <span className="italic text-primary">وجوہات</span> اور <span className="italic text-primary">اثرات</span> کی وضاحت کرے۔
                        </p>
                    </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                    {[
                        ...
                        <div key={idx} className="bg-zinc-50 p-8 rounded-[2rem] border border-zinc-100 group hover:bg-black hover:text-white transition-all duration-500 flex flex-col justify-end min-h-[160px] text-right">
                            <h4 className="text-4xl font-black group-hover:scale-110 transition-transform origin-right" dir="ltr">{stat.num}</h4>
                            <p className="text-sm font-black text-primary group-hover:text-white transition-colors">{stat.label}</p>
                        </div>
                    ))}
                </div>
            </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-12 relative z-10">
                        {[
                            ...
                            <div key={i} className="space-y-4 border-r border-white/10 pr-8">
                                <span className="text-primary font-black italic text-4xl opacity-50">0{i + 1}</span>
        ...
        <div className="min-h-screen bg-white font-serif pb-20 text-right" dir="rtl">
            ...
            <div className="pt-32 pb-24 bg-primary rounded-b-[4rem] px-4 text-center relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <p className="text-white/90 text-lg md:text-2xl font-medium max-w-2xl mx-auto opacity-90 leading-relaxed">
            ...
            <div className="max-w-6xl mx-auto px-4 -mt-10 relative z-20">
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-zinc-100 hover:border-primary transition-colors group">
                        ...
                        <h3 className="text-3xl font-black text-zinc-900 uppercase tracking-tight mb-4">ڈیجیٹل رئیل اسٹیٹ</h3>
                        ...
                        <ul className="space-y-4 mb-10">
                            {[
                                ...
                                <li key={i} className="flex gap-3 text-md font-bold text-zinc-700 items-baseline">
                        ...
                        <ul className="space-y-4 mb-10">
                            {[
                                ...
                                <li key={i} className="flex gap-3 text-md font-bold text-zinc-400 items-baseline">
                                    <CheckCircle2 size={16} className="text-primary shrink-0 mt-1" /> {item}
                                </li>
                            ))}
                        </ul>
                    </div>
                ...
                <div className="mt-20 p-12 md:p-20 bg-zinc-50 rounded-[4rem] text-center border-2 border-dashed border-gray-200">
                    <h2 className="text-4xl md:text-5xl font-black text-zinc-900 mb-6">ہمارے ساتھ <span className="text-primary italic">شراکت داری کریں</span></h2>
                    ...
                    <a href="mailto:asrehazir.web@gmail.com" className="inline-flex items-center gap-3 bg-primary text-white font-black px-12 py-5 rounded-2xl uppercase tracking-widest text-sm hover:bg-black transition-all shadow-xl shadow-primary/20 active:scale-95">
            ...
            <div className="pt-32 pb-20 px-4 max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-12 gap-16 items-start">
                    <div className="lg:col-span-7 space-y-10">
                        <div className="space-y-4">
                            <span className="text-primary font-black uppercase tracking-[0.3em] text-sm flex items-center gap-2">
                                <div className="w-10 h-0.5 bg-primary"></div> اپنی تحریر ارسال کریں
                            </span>
                            <h1 className="text-6xl font-black text-zinc-900 uppercase leading-none tracking-tighter">
                                عالمی <span className="text-primary italic underline decoration-zinc-100 decoration-8 underline-offset-8">آرکائیو</span> کے لیے لکھیں
                            </h1>
                        </div>
                        <div className="prose prose-zinc lg:prose-xl italic text-zinc-500 leading-relaxed font-bold">
                        ...
                        <div className="p-8 bg-zinc-50 rounded-[2.5rem] border border-zinc-100 space-y-6">
                            <h3 className="text-2xl font-black text-zinc-900">ارسال کرنے کے ضوابط</h3>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {[
                                    { icon: <CheckCircle2 size={24} className="text-primary" />, t: "الفاظ کی تعداد", d: "800 - 1500 الفاظ" },
                                    { icon: <CheckCircle2 size={24} className="text-primary" />, t: "اصلیت", d: "100% منفرد مواد" },
                                    { icon: <CheckCircle2 size={24} className="text-primary" />, t: "میڈیا", d: "مصنف کی تصویر" },
                                    { icon: <CheckCircle2 size={24} className="text-primary" />, t: "فارمیٹ", d: "ورڈ یا گوگل ڈاک" }
                                ].map((item, i) => (
                                    <div key={i} className="flex gap-3 items-center">
                                        {item.icon}
                                        <div>
                                            <p className="text-[12px] font-black uppercase text-zinc-400">{item.t}</p>
                                            <p className="text-md font-bold text-zinc-900">{item.d}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="bg-zinc-900 rounded-[3rem] p-10 text-white shadow-3xl relative overflow-hidden">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-6 bg-white/5 rounded-2xl border border-white/10 text-center">
                                    <p className="text-[12px] font-black uppercase tracking-[0.2em] text-primary mb-2">ایڈیٹر کا ان باکس</p>
                                    <a href="mailto:asrehazir.web@gmail.com" className="text-xl font-bold hover:text-primary transition-colors">asrehazir.web@gmail.com</a>
                                </div>
        ...
        <div className="min-h-screen bg-white font-serif pb-20 text-right" dir="rtl">
            <div className="pt-32 pb-16 px-4 max-w-4xl mx-auto">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black text-zinc-900 uppercase tracking-tighter">رازداری کا <span className="text-primary">چارٹر</span></h1>
                </div>

                <div className="prose prose-zinc max-w-none space-y-12 text-zinc-600 leading-relaxed font-medium">
                    <section className="space-y-4">
                        <h3 className="text-3xl font-black text-zinc-900 uppercase tracking-tight flex items-center gap-3">
                            <div className="w-6 h-1 bg-primary"></div> صارف کے ڈیٹا کی سالمیت
                        </h3>
                    ...
                    <section className="space-y-4 p-8 bg-zinc-50 rounded-[2.5rem] border border-zinc-100 text-right">
                        <h3 className="text-2xl font-black text-zinc-900 uppercase tracking-tight">معلومات کا اطلاق</h3>
                        <ul className="space-y-3 list-none p-0">
                            {[
                                ...
                                <li key={i} className="flex gap-3 items-center text-md font-bold">
                                    <CheckCircle2 size={18} className="text-primary shrink-0" /> {li}
                                </li>
                            ))}
                        </ul>
                    </section>
                    ...
                    <section className="space-y-4">
                        <h3 className="text-3xl font-black text-zinc-900 uppercase tracking-tight flex items-center gap-3">
                            <div className="w-6 h-1 bg-primary"></div> سائبر سیکیورٹی اور تحفظ
                        </h3>
        ...
        <div className="min-h-screen bg-white font-serif pb-20 text-right" dir="rtl">
            <div className="pt-32 pb-16 px-4 max-w-4xl mx-auto">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black text-zinc-900 uppercase tracking-tighter">استعمال کے <span className="text-primary">پروٹوکولز</span></h1>
                </div>
                ...
                <div className="space-y-12 text-right">
                    {[
                        ...
                        <div key={idx} className="group p-10 rounded-[3rem] border border-zinc-100 hover:border-primary transition-all duration-500">
                            <h3 className="text-2xl font-black text-zinc-900 uppercase mb-4 group-hover:text-primary transition-colors tracking-tight">{item.t}</h3>
                            <p className="text-zinc-500 leading-relaxed font-medium text-lg">{item.d}</p>
                        </div>
                    ))}
                </div>
