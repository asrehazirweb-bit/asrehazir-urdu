            ...
            <div className="flex flex-col gap-8">
                ...
                <Link to={`/news/${featured.id}`} className="group cursor-pointer flex flex-col md:flex-row-reverse gap-6 items-start">
                    ...
                    <div className="flex-1 flex flex-col h-[260px] py-1 text-right">
                        <h3 className="text-xl md:text-2xl font-bold leading-[1.4] text-secondary mb-3 group-hover:underline decoration-accent decoration-2 underline-offset-4 line-clamp-2">
                            {featured.title}
                        </h3>
