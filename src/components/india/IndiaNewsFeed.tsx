    ...
    return (
        <div className="flex flex-col w-full font-serif text-right">
            ...
            <div className="flex flex-col gap-8">
                {items.map((article) => (
                    <Link key={article.id} to={`/news/${article.id}`} className="group flex flex-col md:flex-row-reverse gap-6 border-b border-gray-100 pb-8 last:border-0 last:pb-0 block cursor-pointer">
